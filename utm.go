...
// FromLatLonZone convert a latitude and longitude to Universal Transverse Mercator coordinates
// enforcing a particular zone, which is useful where maps overlap zone edges
